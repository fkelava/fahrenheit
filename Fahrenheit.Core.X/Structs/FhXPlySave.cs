...
[Flags]
public enum FhXPlySaveAbilityMap_B0 : byte
{
...
[Flags]
public enum FhXPlySaveAbilityMap_B1 : byte
{
    PLY_ABI_FLEE   = 1 << 0,
    PLY_ABI_PRAY   = 1 << 1,
    PLY_ABI_CHEER  = 1 << 2,
...
[Flags]
public enum FhXPlySaveAbilityMap_B2 : byte
{
    PLY_ABI_LANCET      = 1 << 0,
    PLY_ABI_UNUSED      = 1 << 1,
    PLY_ABI_GUARD       = 1 << 2,
...
[Flags]
public enum FhXPlySaveAbilityMap_B3 : byte
{
    PLY_ABI_COPYCAT    = 1 << 0,
...
[Flags]
public enum FhXPlySaveAbilityMap_B4 : byte
{
...
[Flags]
public enum FhXPlySaveAbilityMap_B5 : byte
{
    PLY_ABI_SLOW    = 1 << 0,
    PLY_ABI_SLOWGA  = 1 << 1,
    PLY_ABI_SHELL   = 1 << 2,
...
[Flags]
public enum FhXPlySaveAbilityMap_B6 : byte
{
...
[Flags]
public enum FhXPlySaveAbilityMap_B7 : byte
{
    PLY_ABI_WATERA   = 1 << 0,
    PLY_ABI_FIRAGA   = 1 << 1,
...
[Flags]
public enum FhXPlySaveAbilityMap_B8 : byte
{
    PLY_ABI_DRAIN  = 1 << 0,
    PLY_ABI_OSMOSE = 1 << 1,
    PLY_ABI_FLARE  = 1 << 2,
...
[Flags]
public enum FhXPlySaveAbilityMap_B9 : byte
{
...
[Flags]
public enum FhXPlySaveOverdriveMap_B0 : byte
{
...
[Flags]
public enum FhXPlySaveOverdriveMap_B1 : byte
{
...
[Flags]
public enum FhXPlySaveOverdriveMap_B2 : byte
{
...
{
    [FieldOffset(0x00)] public readonly uint                      FIELD_UNK_0x0;
    ...
    [FieldOffset(0x14)] public readonly ushort                    FIELD_UNK_0x14;
    [FieldOffset(0x16)] public readonly ushort                    FIELD_UNK_0x18;
    ...
    [FieldOffset(0x37)] public readonly byte                      FIELD_UNK_0x37;
    ...
    [FieldOffset(0x3D)] public readonly byte                      FIELD_UNK_0x3D;
    [FieldOffset(0x3E)] public readonly byte                      FIELD_UNK_0x3E;
    [FieldOffset(0x3F)] public readonly byte                      FIELD_UNK_0x3F;
    [FieldOffset(0x40)] public readonly FhXPlySaveAbilityMap_B0   ply_abi_map_b0;
    [FieldOffset(0x41)] public readonly FhXPlySaveAbilityMap_B1   ply_abi_map_b1;
    [FieldOffset(0x42)] public readonly FhXPlySaveAbilityMap_B2   ply_abi_map_b2;
    [FieldOffset(0x43)] public readonly FhXPlySaveAbilityMap_B3   ply_abi_map_b3;
    [FieldOffset(0x44)] public readonly FhXPlySaveAbilityMap_B4   ply_abi_map_b4;
    [FieldOffset(0x45)] public readonly FhXPlySaveAbilityMap_B5   ply_abi_map_b5;
    [FieldOffset(0x46)] public readonly FhXPlySaveAbilityMap_B6   ply_abi_map_b6;
    [FieldOffset(0x47)] public readonly FhXPlySaveAbilityMap_B7   ply_abi_map_b7;
    [FieldOffset(0x48)] public readonly FhXPlySaveAbilityMap_B8   ply_abi_map_b8;
    [FieldOffset(0x49)] public readonly FhXPlySaveAbilityMap_B9   ply_abi_map_b9;
    [FieldOffset(0x4A)] public readonly ushort                    FIELD_UNK_0x4A;
    [FieldOffset(0x4C)] public readonly uint                      FIELD_UNK_0x4C;
    [FieldOffset(0x50)] public readonly uint                      ply_encounter_count;
    [FieldOffset(0x54)] public readonly uint                      ply_enemies_defeated;
    [FieldOffset(0x58)] public readonly uint                      FIELD_UNK_0x58;
    [FieldOffset(0x5C)] public readonly uint                      FIELD_UNK_0x5C;
    ...
    [FieldOffset(0x88)] public readonly FhXPlySaveOverdriveMap_B0 ply_ovr_map_b0;
    [FieldOffset(0x89)] public readonly FhXPlySaveOverdriveMap_B1 ply_ovr_map_b1;
    [FieldOffset(0x8A)] public readonly FhXPlySaveOverdriveMap_B2 ply_ovr_map_b2;
    [FieldOffset(0x8C)] public readonly uint                      FIELD_UNK_0x8C;
    [FieldOffset(0x90)] public readonly uint                      FIELD_UNK_0x90;
}